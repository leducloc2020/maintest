                    ...
                    <div className='w-1/3 rounded-md justify-center flex border'>
                        <div className='flex flex-col w-full mx-4'>
                            ...
                            <div className='mt-4 w-full'>
                                <tr className="flex flex-col dark:bg-gray-800 dark:border-gray-700">
                                    <th className='w-2/3 text-sm mx-2 text-violet-900'>Username</th>
                                    <td scope="row" className="px-2 py-2 border mb-2 rounded font-medium text-sm whitespace-nowrap dark:text-white">
                                        {user.username}
                                    </td>
                                    <th className='w-2/3 text-sm mx-2 text-violet-900'>Email</th>
                                    <input onChange={handleChange} defaultValue={user.email} id="email" placeholder="email..." className="px-2 py-2 border mb-2 rounded font-medium text-sm whitespace-nowrap dark:text-white" />
                                    <th className='w-2/3 text-sm mx-2 text-violet-900'>Role</th>
                                    <input onChange={handleChange} defaultValue={user.role} id="role" placeholder="role..." className="px-2 py-2 border mb-2 rounded font-medium text-sm whitespace-nowrap dark:text-white" />
                                    ...
                                    {updateSuccess && (
                                        <span className="mt-4 text-green-600">Update successfully!</span>
                                    )}
                                </tr>
                            </div>
                        </div>
